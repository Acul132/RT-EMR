...
import styles from './TransferPatient.module.css'
    ...
    sendQuery(data){
        if(this.state.selectedWard){
            ...
            let body = {
                ...
                to_ward_id: this.state.selectedWard.id,
                from_ward_id: this.props.patientContext.patient.assigned_ward_id,
                transfer_date: new Date().toISOString()
            }
            if(data.doc_id)
                body.assigned_doctor_id = data.doc_id;

            this.context.api.transferPatient(body)
        ...
        return (
            <div>
                ...
                <div className={styles.dosageInformation}>
                    <div className={styles.secondTitle}>Transfer information</div>
                    <div>
                        <Form ref={this.form} onFinish={(data) => {
                            ...
                            <div className={styles.searchParamsContainer}>
                                    ...
                                    <Button text="Transfer patient" onClick={() => {this.form.current.save()}}/>
...
TransferPatient.contextType = Auth0Context
export default withPatientContext(TransferPatient);